...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "employees/test/integration/EmployeesListJourney.gen",
    "employees/test/integration/EmployeesObjectPageJourney.gen",
    "employees/test/integration/ProjectsObjectPageJourney.gen",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
