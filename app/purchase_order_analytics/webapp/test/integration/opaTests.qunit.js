...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "purchaseorderanalytics/test/integration/PurchaseOrdersAnalyticsListJourney.gen",
    "purchaseorderanalytics/test/integration/PurchaseOrdersAnalyticsObjectPageJourney.gen",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
